    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          ...
          Rejeter les demandes d'inscription
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
                 
        <div style={{'fontSize':'16px'}}>Êtes-vous sûr de vouloir rejeter les demandes suivantes ?</div>
